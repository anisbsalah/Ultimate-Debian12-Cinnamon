...
#sudo find /usr/share/icons/default/ -name "index.theme" -exec sed -i 's/mate/Bibata-Modern-Ice/g' {} \;
...
sudo cp -rf /tmp/Catppuccin-Cursors/usr/share/icons/* /usr/share/icons/

#sudo find /usr/share/icons/default/ -name "index.theme" -exec sed -i 's/mate/Catppuccin-Latte-Light-Cursors/g' {} \;
...
sudo cp -rf /tmp/Qogir-Cursors/usr/share/icons/* /usr/share/icons/

sudo find /usr/share/icons/default/ -name "index.theme" -exec sed -i 's/mate/Qogir-Cursors/g' {} \;
