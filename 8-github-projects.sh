...
### lf
mkdir -p /tmp/go
curl -L https://go.dev/dl/go1.21.1.linux-amd64.tar.gz -o /tmp/go/go1.21.1.linux-amd64.tar.gz
sudo rm -rf /usr/local/go && sudo tar -C /usr/local -xzf /tmp/go/go1.21.1.linux-amd64.tar.gz
